    ...
    def __init__(self):
        self.steps_data=[
            [   "Intrinsics analysis",
                ...
                ["-i", "%input_dir%", "-o", "%matches_dir%", "-d", "%camera_file_params%", "-f", "4500"] ],
            [   "Compute features",
            ...
            [   "Densify point cloud",
                ...
                ["-i", "scene.mvs", "-w","%mvs_dir%"]],
            [   "Reconstruct the mesh",
                os.path.join(OPENMVS_BIN,"ReconstructMesh"),
                ["-i", "scene_dense.mvs", "-w","%mvs_dir%", "-v", "2" ]],
            [   "Refine the mesh",
                os.path.join(OPENMVS_BIN,"RefineMesh"),
                ["scene_dense_mesh.mvs", "-w","%mvs_dir%", "-v", "2"]],
            [   "Texture the mesh",
                os.path.join(OPENMVS_BIN,"TextureMesh"),
                ["-i", "scene_dense_mesh_refine.mvs", "-w","%mvs_dir%", "-v", "2"]]
            ]
